<section id="main-content">
                  ...
                  <?php if (count($res) > 0 ): ?>
                    ...
                    <?php foreach ($res as $key => $value): ?>
                      <tr>
                        ...
                        <td>
                          <button type="button"
                          data-payload='<?php echo json_encode(['id' => $value->id, 'division_name' => $value->division_name])?>'
  ...
  <script src="<?php echo base_url('public/admin/js/custom/') ?>divisions_management.js"></script>
