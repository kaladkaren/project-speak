<section id="main-content">
                  ...
                  <?php if (count($res) > 0 ): ?>
                    ...
                    <?php $i = 1; foreach ($res as $key => $value): ?>
                      <tr>
                        ...
                        <td>
                          <button type="button"
                          data-payload='<?php echo json_encode(['id' => $value->id, 'agency_name' => $value->agency_name, 'department_id' => $value->department_id])?>'
  ...
  <script src="<?php echo base_url('public/admin/js/custom/') ?>sub_agencies_management.js"></script>
