<section id="main-content">
        ...
        <section class="panel">
          ...
          <div class="panel-body">
            ...
            <div class="table-responsive" style="overflow: hidden; outline: none;" tabindex="1">
              <table class="table table-bordered">
                ...
                <tbody>
                  <?php if (count($res) > 0 ): ?>
                    ...
                    <?php $i = 1; foreach ($res as $key => $device): ?>
                      <tr>
                        <th scope="row"><?php echo $i++ ?></th>
                        <td><?php echo $device->device_name ?></td>
                        <td><?php echo $device->device_id ?></td>
                        <td>
                          <select class="form-control select-station" data-id="<?php echo $device->id ?>">
              ...
              <!--           <td>
                          <button type="button"
                          data-payload='<?php echo json_encode(['id' => $value->id, 'name' => $value->name, 'email' => $value->email], JSON_HEX_APOS|JSON_HEX_QUOT)?>'
  ...
  <script src="<?php echo base_url('public/admin/js/custom/') ?>devices_management.js"></script>
